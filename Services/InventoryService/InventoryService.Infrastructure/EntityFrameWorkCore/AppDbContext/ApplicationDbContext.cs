...
namespace InventoryService.Infrastructure.EntityFrameWorkCore.AppDbContext
{
    public class ApplicationDbContext : DbContext
    {
        ...
        {
            optionsBuilder.UseSqlServer(ApplicaitonConfiguration.InventoryConnectionSqlString);
